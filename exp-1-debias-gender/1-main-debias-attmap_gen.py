...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="./outputs/gender-debias-text-encoder/BS-32_wImg-2-0.2-0.2_wFace-0_Th-0.2_loraR-50_lr-5e-05_03041519/ckpts/checkpoint_tmp-980",
...
def main(args):
    ...
    def should_trigger_evaluation(current_step: int) -> bool:
        # Evaluate every N steps (default: 200), excluding step 0.
        if args.evaluate_every_n_iter <= 0:
            return False
        return current_step > 0 and (current_step % args.evaluate_every_n_iter == 0)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, data_idx in enumerate(train_dataloader_idxs[epoch]):            
            ...
            with torch.no_grad():
                ...
                targets_all, uncertainty_all = generate_dynamic_targets(probs_gender_all_sds, w_uncertainty=True)
            ...
            if accelerator.is_main_process:
                ...
                for key in ["gender_gap", "gender_gap_abs", "gender_gap_abs_sds","gender_pred_between_0.2_0.8"]:
                    if logs_i[key] == []:
                        logs_i.pop(key)
